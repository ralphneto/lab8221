...
type
	TfrmTransmissaoPrint = class(TForm)
	qrImpacto: TQuickRep;
    qrShape2: TQRShape;
	Titulo: TQRLabel;
    lbEmpresa: TQRLabel;
    ...
    stAceleracaoMaximaNorma: TQRLabel;
    lbVelocidadeImpactoNorma: TQRLabel;
    stVelocidadeImpactoNorma: TQRLabel;
    lbAceleracaoMaxima: TQRLabel;
    stAceleracaoMaxima: TQRLabel;
    QRLabel3: TQRLabel;
...
var
  frmTransmissaoPrint: TfrmTransmissaoPrint;
