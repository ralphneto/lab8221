...
procedure TfrmResultados.spBtnSalvarClick(Sender: TObject);
var AppPath: string;
begin
...
procedure TfrmResultados.FormActivate(Sender: TObject);
begin
     imgGraf.Picture.LoadFromFile(ExtractFilePath(Application.ExeName) + '\GRAFTMP.WMF');
end;

procedure TfrmResultados.SpeedButton2Click(Sender: TObject);
begin
        Close();
end;
