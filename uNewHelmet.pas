...
type
    ...
    procedure ResultadosGerais1Click(Sender: TObject);
	...
	public
		...
		procedure SaveImpacto(FileName: TFileName);
                procedure SaveTransmissao(FileName: String);
...
uses uNormas, uNovoEnsaio, uEmpresas, uCapacetes, uMachineControl,
  ...
  uGeral, uSelEnsaio, uCintaRes, uCintaPrint, uResultadosTrans,
  uGraficoTrans, uTransmissaoPrint;
...
SAVE TRANSMISSAO
===============================================================================}
procedure TfrmHelmet.SaveTransmissao(FileName: String);
var
	fTrans	        :	TextFile;
	i		:	integer;
	dfX		:	single;
...
begin
        ...
        case dlgAbrir.FilterIndex of
                ...
                //3 : LoadPenetração(dlgAbrir.FileName);
                //4 : LoadTransmissao(dlgAbrir.FileName);
        end;
end;
...
procedure TfrmHelmet.ResultadosGerais1Click(Sender: TObject);
begin
        frmGeral.showModal()
end;

procedure TfrmHelmet.btnDiagClick(Sender: TObject);
begin
        if EnsaioAtual = eaTransmissao then
                frmResultadosTrans.showModal
        else if EnsaioAtual = eaImpacto then
                frmResultados.showModal;
end;
